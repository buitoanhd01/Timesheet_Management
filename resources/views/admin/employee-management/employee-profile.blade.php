...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">My Profile /</span> Profile Details</h4>
    <div class="card mb-4">
          ...
          <form id="formAccountSettings" method="POST" action="{{ route('admin-employee-edit',['id' => $employee->id]) }}">
            ...
            <div class="row">
              ...
              <div class="mb-3 col-md-6">
                ...
                <input disabled class="form-control @error('lastName') is-invalid @enderror" type="text" name="lastName" id="lastName" value="{{$employee->last_name}}" required/>
              </div>
              <div class="mb-3 col-md-6">
              ...
              <div class="mb-3 col-md-6">
                ...
                <input type="text" class="form-control" id="address" name="address" placeholder=""  value="{{$employee->address}}" disabled/>
              </div>
              <div class="mb-3 col-md-6">
                <label for="birthday" class="form-label">Birthday</label>
                <input disabled class="form-control daterangepicker" type="text" id="birthday" name="birthday" placeholder="yyyy/mm/dd" autocomplete="off" value="{{$employee->birthday}}"/>
              </div>
              <div class="mb-3 col-md-6">
                <label for="gender" class="form-label">Gender</label>
                <select disabled class="select2 form-select" name="gender" id="gender">
              ...
              <div class="mb-3 col-md-6">
                ...
                <input disabled type="text" class="form-control daterangepicker" id="start_time" name="start_time" placeholder="yyyy/mm/dd" autocomplete="off" value="{{$employee->start_time}}"/>
              </div>
              <div class="mb-3 col-md-6">
                <label for="end_time" class="form-label">End time <span class="required-field text-danger">*</span></label>
                <input disabled type="text" class="form-control daterangepicker" id="end_time" name="end_time" placeholder="yyyy/mm/dd" autocomplete="off" value="{{$employee->end_time}}"/>
              </div>
              <div class="mb-3 col-md-6">
                <label class="form-label" for="employee_type">Employee Type</label>
                <select disabled id="employee_type" name="employee_type" class="select2 form-select">
              ...
              <div class="mb-3 col-md-6">
                ...
                <select disabled id="status" name="status" class="select2 form-select">
              ...
              <div class="mb-3 col-md-6">
                ...
                <select disabled id="position" name="position" class="select2 form-select">
              ...
              <div class="mb-3 col-md-6">
                ...
                <select disabled id="department" name="department" class="select2 form-select">
            ...
            <div class="mt-2">
              ...
              {{-- <a type="button" href="#" class="btn btn-outline-secondary">Cancel</a> --}}
            </div>
          </form>
        </div>
        <!-- /Account -->
