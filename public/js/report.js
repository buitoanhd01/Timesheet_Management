    ...
    loadTable();
      function loadTable() {
        ...
        dateFilter = dateFilter.replace('/', '-')
          $.ajax({
              url: '/admin/report/view', // đường dẫn tới tệp JSON trên máy chủ
              method: 'GET',
      ...
      function loadTableOvertime() {
        ...
        dateFilter = dateFilter.replace('/', '-')
          $.ajax({
              url: '/admin/report/overtime', // đường dẫn tới tệp JSON trên máy chủ
              method: 'GET',
              dataType: 'json', // định dạng dữ liệu là JSON
              data: {
                dateFilter: dateFilter,
      ...
      function loadTableTotal() {
        ...
        dateFilter = dateFilter.replace('/', '-')
          $.ajax({
              url: '/admin/report/total', // đường dẫn tới tệp JSON trên máy chủ
              method: 'GET',
              dataType: 'json', // định dạng dữ liệu là JSON
              data: {
                dateFilter: dateFilter,
