(function ($) {
    ...
    loadTable(current_tab, dateFilter, dataFilter);
    ...
    function loadTable(current_tab, dateFilter, dataFilter) {
      $.ajax({
        url: $('#get_self_calendar').val(), // đường dẫn tới tệp JSON trên máy chủ
        method: 'GET',
